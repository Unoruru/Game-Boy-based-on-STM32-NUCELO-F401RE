...
// Note: Ensure you have included SEGGER headers if you use them below
...
// The array that DMA will fill automatically.
// 'volatile' is critical so the compiler knows hardware changes it.
